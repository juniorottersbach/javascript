...
let lista = document.querySelector('select#iflis')
...
function finalizar() {
    if (valores.length == 0) {
        ...
        media = soma/tot
        res.innerHTML = ''
        res.innerHTML += `<p>Ao todo, existem ${tot} números.</p>`
        res.innerHTML += `<p>O maior dos valores: ${maior}.</p>`
        res.innerHTML += `<p>O menor dos valores: ${menor}.</p>`
